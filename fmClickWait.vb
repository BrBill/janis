...
#Region " Windows Form Designer generated code "
        ...
        Public Sub New(ByVal Owner As fmMain)
            MyBase.New()
            Me.MyOwner = Owner
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Label1.Text = "To stop the Whammy! random selector, click the mouse" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & " in this window, or hit any" &
    " key." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "If you click somewhere else, I can't be held responsible for what happe" &
    "ns."
...
#End Region
        ...
        Private Sub fmClickWait_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Me.Location = New Point(MyOwner.Left + CInt((MyOwner.Width - Me.Width) / 2), MyOwner.Top + CInt((MyOwner.Height - Me.Height)))
        ...
        Private Sub CenterMouseOnForm()
            ...
            System.Windows.Forms.Cursor.Position = New Point(Me.Left + CInt(Me.Width / 2), Me.Top + CInt(Me.Height / 2))
        End Sub
